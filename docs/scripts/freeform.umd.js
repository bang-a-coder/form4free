(function (global, factory) {
    ...
    const Answer = (content,subQ) => H()
                                        .run(function(){
                                            ...
                                            this.as(j(`<div class="answer">
                                            <div id='content'>${this.content}</div>
                                        </div>`.trim()));

                                            if (this.icon){
                                                let icon = icons[this.icon];
                                                icon && this.prepend(j("div.icon#").html(icon));
                                            }
                                        })
                                        .run(function() {
                                            this.subQ = subQ;
