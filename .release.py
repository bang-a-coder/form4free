...
package_manager = os.environ.get('freeform_PKG') or "yarn"
...
os.environ["freeform_ENV"] = 'production'
...
# set version
v = '0.0.1'
resp = requests.get(f"https://registry.npmjs.org/form4free")
if resp.status_code == 200: v = resp.json()['dist-tags']['latest']
